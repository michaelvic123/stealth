...
- Name: search.spec.ts >> search and filter >> filter dropdown allows selecting a date range
- Location: tests\e2e\search.spec.ts:62:3
...
Call log:
  ...
  - waiting for getByText('This week')

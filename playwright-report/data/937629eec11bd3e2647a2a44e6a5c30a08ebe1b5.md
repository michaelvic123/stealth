...
- Name: calendar.spec.ts >> calendar linking >> opens the calendar workspace from the sidebar calendar button
- Location: tests\e2e\calendar.spec.ts:32:3
...
Call log:
  - waiting for getByRole('button', { name: /Add to calendar/i })
